...
{{-- Content --}}
<div class="p-6 mx-auto min-w-full md:max-w-8xl lg:p-8">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
            ...
            <div
                ...
                <select wire:model.lazy="from_lang" id="countries"
                        class="max-w-fit mb-4 p-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option selected>Choose a language</option>

                    {{-- List available languages support by ACS --}}
                    @foreach ($languages as $language)
                        <option wire:key="{{ $language['code'] }}"
                ...
                <div class="mt-4 flex justify-end">
                    <button wire:loading.remove wire:target="translate" type="submit"
                        ...
                        <x-gmdi-translate class="mr-2 2-4 h-4"/>
                        Translate
                    </button>
            ...
            <div
                class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none focus:outline focus:outline-2 focus:outline-indigo-500">


                <div class="min-w-full flex justify-between items-center align-middle">
                    <div>
                        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Translate to
                        </label>
